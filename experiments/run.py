...
def parse_args():
    ...
    parser.add_argument("--split", type=str, required=True, help="Split file name.")
...
if __name__ == "__main__":
    ...
    run_experiment(algorithms=algos,k_values=k_values,n_trials=args.trials,fitness_fn=args.fitness,split=args.split)
